...
<template>
  <div class="flex flex-col items-center justify-center mt-16">
    <div class="bg-gray-50 p-8 rounded-lg shadow-md w-3/4 flex items-center justify-center flex flex-col">
      ...
      <div class="flex flex-col w-full">
        ...
        <div>
          <!--Email field-->
          <label for="password" class="block text-gray-700 font-bold mb-2">Email:</label>
          <input type="email" id="email" name="email"
            class="w-full border border-gray-300 p-2 rounded-md focus:outline-none focus:border-blue-500 mb-3"
            v-model="email" required="" />
        </div>
        <div class="flex justify-center space-x-4">
          <!--Edit button for Username or Email changing-->
          <button type="submit"
  ...
  <!-- favFund -->
  <div class="flex flex-col items-center justify-center mt-16">
    <div class="bg-gray-50 p-8 rounded-lg shadow-md w-full h-[400px] sm:w-3/4 overflow-auto">
